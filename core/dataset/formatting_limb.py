...
class PackPoseInputs_limb(BaseTransform):
    ...
    field_mapping_table = dict(
        heatmaps='heatmaps',
        limb_heatmaps='limb_heatmaps', # new
    ...
    def transform(self, results: dict) -> dict:
        ...
        _label_mapping_table = self.label_mapping_table
        ...
        _field_mapping_table = self.field_mapping_table
